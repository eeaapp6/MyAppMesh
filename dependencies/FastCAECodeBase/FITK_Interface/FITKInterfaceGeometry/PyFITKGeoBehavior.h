...
namespace Interface
{
    ...
    public:
        ...
        */
        ...
        /**
         * @brief  扫掠实体/面/切削
         * @param[i] 第一个参数是脊线  第二个参数是截面  第三个参数是类型1实体 2面 3切削 (第四个参数为是否反向)
         * @author wangning(2185896382@qq.com)
         * @date   2025-06-25
         */
        Interface::FITKAbsGeoCommand* sweepByEdgeFace(const QList<int>& indexEdge, int indexFace, int type, bool flip = false);
        Interface::FITKAbsGeoCommand* sweepBySketchFace(const QString& sketchNameEdge, int indexFace, int type);
        Interface::FITKAbsGeoCommand* sweepByEdgeSketch(const QList<int>& indexEdge, const QString& sketchNameFace, int type, bool flip = false);
        ...
        */
         ...
         * @date   2025-06-25
         */
        Interface::FITKAbsGeoCommand* mergeEdges(const QList<int>& edgeIndexs);
        /*
        * @brief  修复小面
        ...
        */
        ...
        /*
        * @brief  移除线边（仅支持 wire edge）
        * @edgeIndexs edgeIndexs 边索引
        * @author wangning(2185896382@qq.com)
        * @date   2025-06-25
        */
        Interface::FITKAbsGeoCommand* removeWireEdges(const QList<int>& edgeIndexs);
        /*
        * @brief  边生成面
        * @edgeIndexs edgeIndexs 边索引
        * @author wangning(2185896382@qq.com)
        ...
        */
        ...
        /*
         * @brief  延伸面
         * @edgeIndexs  edgeIndexs边索引 faceIndexs面索引 tagFaceIndexs标记面索引 distance延伸长度 SpecifyModel延伸面选择方法 MethodModel延伸面方法
         * @author wangning(2185896382@qq.com)
         * @date   2025-06-25
         */
        Interface::FITKAbsGeoCommand* extendFaces(const QList<int>& edgeIndexs, const QList<int>& faceIndexs, 
    ...
    public:
        ...
        */
        ...
        Interface::VirtualShape        getShape(int indexs, Interface::FITKGeoEnum::VTopoShapeType type);
