...
namespace Interface
{
    ...
    void FITKGeoMeshVSPt::getXYZ(float& x, float& y, float& z) const
    {
        x = _coor[0];
        y = _coor[1];
        z = _coor[2];
    ...
    void FITKGeoMeshVSPt::getXYZDb(double& x, double& y, double& z) const
    {
        x = static_cast<double>(_coor[0]);
        y = static_cast<double>(_coor[1]);
        z = static_cast<double>(_coor[2]);
    }
