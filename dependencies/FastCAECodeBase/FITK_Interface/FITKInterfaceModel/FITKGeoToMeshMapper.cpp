...
namespace Interface
{
    ...
    void FITKGeoToMeshMapper::insertMeshEleOfGeoFace(int faceID, int eleID, int faceIndex)
    {
        ...
        _meshEleOfGeoFace[faceID][eleID].append(faceIndex);
    }
    ...
    const QHash<int, QHash<int, QList<int>>>& FITKGeoToMeshMapper::getMeshEleOfGeoFace()
    {
    ...
    void FITKGeoToMeshMapper::insertMeshEleOfGeoCoplane(FITKGeoToMeshMapStrSolidFace solidAndFace, int eleID, int faceIndex)
    {
        ...
        _meshEleOfGeoCoplane[solidAndFace][eleID].append(faceIndex);
    }

    const QHash<FITKGeoToMeshMapStrSolidFace, QHash<int, QList<int>>>& FITKGeoToMeshMapper::getMeshEleOfGeoCoplane()
    {
    ...
    void FITKGeoToMeshMapper::insertMeshEleOfGeoEdge(int edgeID, int eleID, int edgeIndex)
    {
        ...
        _meshEleOfGeoEdge[edgeID][eleID].append(edgeIndex);
    }
    ...
    const QHash<int, QHash<int, QList<int>>>& FITKGeoToMeshMapper::getMeshEleOfGeoEdge()
    {
