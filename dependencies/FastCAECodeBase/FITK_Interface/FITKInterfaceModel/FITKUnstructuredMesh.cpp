...
namespace Interface
{
    ...
    bool FITKUnstructuredMesh::hasModelDim(FITKModelEnum::FITKModelDim dim)
    {
        int iDim = -1;
        switch (dim)
        {
    ...
    void FITKUnstructuredMesh::clearUnstructuredMeshTopo()
    {
        if (_meshTopo)
        {
            delete _meshTopo;
