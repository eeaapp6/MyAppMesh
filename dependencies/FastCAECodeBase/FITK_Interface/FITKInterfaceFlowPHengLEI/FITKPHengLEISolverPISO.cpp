...
namespace Interface
{
    ...
    FITKPHengLEISolverPISO::FITKPHengLEISolverPISO()
    {
		this->setDataObjectName("PISO");

        this->init();
    }

    FITKPHengLEIAbsSolver::PHengLEISolverType FITKPHengLEISolverPISO::getSolverType()
    {
        //PISO类型
        return  FITKPHengLEIAbsSolver::PHengLEISolverType::PLPISO;
    }

    void FITKPHengLEISolverPISO::initBoundaryTypes()
    {
    ...
    void FITKPHengLEISolverPISO::initBasicInfo()
    {
    ...
    void FITKPHengLEISolverPISO::initInflow()
    {
    ...
    void FITKPHengLEISolverPISO::initGridParam()
    {
    ...
    void FITKPHengLEISolverPISO::initViscous()
    {

    }

    void FITKPHengLEISolverPISO::initDiscrete()
    {
    ...
    void FITKPHengLEISolverPISO::initMultiGridParam()
    {
	...
	void FITKPHengLEISolverPISO::initOutputSetting()
	{
	...
	void FITKPHengLEISolverPISO::initFlow()
	{
		if (_flow) delete _flow;
		_flow = nullptr;
		return;
	...
	void FITKPHengLEISolverPISO::initCalculation()
	{
	...
	void FITKPHengLEISolverPISO::initInitialCondition()
	{
	...
	void FITKPHengLEISolverPISO::initSolution()
	{
	...
	void FITKPHengLEISolverPISO::initModels()
	{
		if (!_models) return;
		// 添加EnergyModel参数
