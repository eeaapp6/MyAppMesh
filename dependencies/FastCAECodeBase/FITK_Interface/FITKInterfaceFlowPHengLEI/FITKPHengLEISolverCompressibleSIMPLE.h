...
/**
 * 
 * @file FITKPHengLEISolverCompressibleSIMPLE.h
 * @brief CompressibleSIMPLE求解器
 * @author LiBaojun (libaojunqd@foxmail.com)
 * @date 2024-09-11
 * 
 */
#ifndef _FITK_PHENGLEI_SOLVER_CompressibleSIMPLE__H___
#define _FITK_PHENGLEI_SOLVER_CompressibleSIMPLE__H___
...
namespace Interface
{
     ...
     * @date 2024-09-11
     */
    class FITKFlowPHengLEIAPI FITKPHengLEISolverCompressibleSIMPLE : public FITKPHengLEIAbsSolver
    {
    public:
        /**
         * @brief Construct a new FITKPHengLEISolverCompressibleSIMPLE object
         * @author LiBaojun (libaojunqd@foxmail.com)
         * @date 2024-09-11
         */
        explicit FITKPHengLEISolverCompressibleSIMPLE();
        /**
         * @brief Destroy the FITKPHengLEISolverCompressibleSIMPLE object
         * @author LiBaojun (libaojunqd@foxmail.com)
         * @date 2024-09-11
         */
        virtual ~FITKPHengLEISolverCompressibleSIMPLE() = default;
        /**
         * @brief 获取求解器类型
