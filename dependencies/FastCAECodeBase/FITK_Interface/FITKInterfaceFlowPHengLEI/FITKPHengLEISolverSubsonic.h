...
/**
 * 
 * @file FITKPHengLEISolverSubsonic.h
 * @brief 亚音速求解器
 * @author LiBaojun (libaojunqd@foxmail.com)
 * @date 2024-09-11
 * 
 */
#ifndef _FITK_PHENGLEI_SOLVER_SUBSONIC__H___
#define _FITK_PHENGLEI_SOLVER_SUBSONIC__H___
...
namespace Interface
{
     ...
     * @date 2024-09-11
     */
    class FITKFlowPHengLEIAPI FITKPHengLEISubsonicSolver : public FITKPHengLEIAbsSolver
    {
    public:
        /**
         * @brief Construct a new FITKPHengLEISubsonicSolver object
         * @author LiBaojun (libaojunqd@foxmail.com)
         * @date 2024-09-11
         */
        explicit FITKPHengLEISubsonicSolver();
        /**
         * @brief Destroy the FITKPHengLEISubsonicSolver object
         * @author LiBaojun (libaojunqd@foxmail.com)
         * @date 2024-09-11
         */
        virtual ~FITKPHengLEISubsonicSolver() = default;
        /**
         * @brief 获取求解器类型
