...
#include "FITKPHengLEIWriteCFDSupersonic.h"
...
namespace Interface
{
	bool FITKPHengLEIWriteCFDSupersonic::writeParamFile()
	{
				//创建文件
	...
	void FITKPHengLEIWriteCFDSupersonic::consoleMessage(int level, const QString& str)
	{
		return;
	}

	void FITKPHengLEIWriteCFDSupersonic::run()
	{
		writeParamFile();
		closeFileStream();
		return;
