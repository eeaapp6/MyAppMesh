...
/**
 * 
 * @file FITKPHengLEISolverTransonic.h
 * @brief  跨音速求解器
 * @author LiBaojun (libaojunqd@foxmail.com)
 * @date 2024-09-11
 * 
 */
#ifndef _FITK_PHENGLEI_SOLVER_TRANSONIC__H___
#define _FITK_PHENGLEI_SOLVER_TRANSONIC__H___
...
namespace Interface
{
     ...
     * @date 2024-09-11
     */
    class FITKFlowPHengLEIAPI FITKPHengLEITransonicSolver : public FITKPHengLEIAbsSolver
    {
    public:
        /**
         * @brief Construct a new FITKPHengLEITransonicSolver object
         * @author LiBaojun (libaojunqd@foxmail.com)
         * @date 2024-09-11
         */
        explicit FITKPHengLEITransonicSolver();
        /**
         * @brief Destroy the FITKPHengLEITransonicSolver object
         * @author LiBaojun (libaojunqd@foxmail.com)
         * @date 2024-09-11
         */
        virtual ~FITKPHengLEITransonicSolver() = default;
        /**
         * @brief 获取求解器类型
