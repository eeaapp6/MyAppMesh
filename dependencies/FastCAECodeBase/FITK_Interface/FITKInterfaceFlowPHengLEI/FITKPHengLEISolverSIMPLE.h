...
/**
 * 
 * @file FITKPHengLEISolverSIMPLE.h
 * @brief SIMPLE求解器
 * @author LiBaojun (libaojunqd@foxmail.com)
 * @date 2024-09-11
 * 
 */
#ifndef _FITK_PHENGLEI_SOLVER_SIMPLE__H___
#define _FITK_PHENGLEI_SOLVER_SIMPLE__H___
...
namespace Interface
{
     ...
     * @date 2024-09-11
     */
    class FITKFlowPHengLEIAPI FITKPHengLEISolverSIMPLE : public FITKPHengLEIAbsSolver
    {
    public:
        /**
         * @brief Construct a new FITKPHengLEISolverSIMPLE object
         * @author LiBaojun (libaojunqd@foxmail.com)
         * @date 2024-09-11
         */
        explicit FITKPHengLEISolverSIMPLE();
        /**
         * @brief Destroy the FITKPHengLEISolverSIMPLE object
         * @author LiBaojun (libaojunqd@foxmail.com)
         * @date 2024-09-11
         */
        virtual ~FITKPHengLEISolverSIMPLE() = default;
        /**
         * @brief 获取求解器类型
