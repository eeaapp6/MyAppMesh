...
#include "FITKPHengLEIWriteCFDHypersonsic.h"
...
namespace Interface
{
	bool FITKPHengLEIWriteCFDHypersonsic::writeParamFile()
	{
 		//创建文件
	...
	void FITKPHengLEIWriteCFDHypersonsic::consoleMessage(int level, const QString& str)
	{
		return;
	}

	void FITKPHengLEIWriteCFDHypersonsic::run()
	{
		writeParamFile();
		closeFileStream();
		return;
