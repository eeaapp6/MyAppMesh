...
public:
    ...
    /**
     * @brief       Wether to use triangle filter for the input data. If true, the input data will be triangulated.[static]
     * @param[in]   flag: Whether to use triangle filter
     * @author      ChengHaotian (yeguangbaozi@foxmail.com)
     * @date        2026-07-09
     */
    static void SetUseTriangleFilter(bool flag);

    /**
     * @brief       Get whether to use triangle filter for the input data.[static]
     * @return      Whether to use triangle filter
     * @author      ChengHaotian (yeguangbaozi@foxmail.com)
     * @date        2026-07-09
     */
    static bool GetUseTriangleFilter();
    ...
    /**
     * @brief       Get the cell id by triangle cell id.
     * @param[in]   triangleCellId: The triangle cell id
     * @return      The cell id, -1 means not found
     * @author      ChengHaotian (yeguangbaozi@foxmail.com)
     * @date        2024-11-08
     */
    int getTriCellId(int triangleCellId);
...
protected:
    ...
    /**
     * @brief       Whether to use the triangle filter for the input data.[static]
     * @author      ChengHaotian (yeguangbaozi@foxmail.com)
     * @date        2026-07-09
     */
    static bool s_useTriangleFilter;

    /**
     * @brief       The internal triangle filter for the input data.
     * @author      ChengHaotian (yeguangbaozi@foxmail.com)
     * @date        2026-07-09
     */
    vtkTriangleFilter* m_triangleFilter{ nullptr };
