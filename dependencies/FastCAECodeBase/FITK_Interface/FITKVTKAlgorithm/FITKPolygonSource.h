...
public:
     ...
     * is set to six, if the number of sides is 2, then the algorithm will pass throuph
     * an 'X' shape source data.
     */
    ...
    /**
     * Set/Get the view up direction of the plane. By default, the direction 
     * is set to (0,1,0).
     */
