...
namespace Interface
{
     ...
     * @date        2026-07-06
     */
    class FITKINTERFACEGEOIOHDF5API FITKAdaptorGeoModelSolidFromShell : public FITKAdaptorGeoCommand
    {
    public:

        explicit FITKAdaptorGeoModelSolidFromShell() = default;
        virtual ~FITKAdaptorGeoModelSolidFromShell() = default;
    protected:
