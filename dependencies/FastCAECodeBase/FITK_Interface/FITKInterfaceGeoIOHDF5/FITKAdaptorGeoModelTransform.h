...
namespace Interface
{
     ...
     * @brief  Part平移适配器
     */
    class FITKINTERFACEGEOIOHDF5API FITKAdaptorGeoModelTranslatePart : public FITKAdaptorGeoCommand
    {
    public:
        explicit FITKAdaptorGeoModelTranslatePart() = default;
        virtual ~FITKAdaptorGeoModelTranslatePart() = default;
     ...
     * @brief  Part旋转适配器
     */
    class FITKINTERFACEGEOIOHDF5API FITKAdaptorGeoModelRotatePart : public FITKAdaptorGeoCommand
    {
    public:
        explicit FITKAdaptorGeoModelRotatePart() = default;
        virtual ~FITKAdaptorGeoModelRotatePart() = default;
     ...
     * @brief  Part缩放适配器
     */
    class FITKINTERFACEGEOIOHDF5API FITKAdaptorGeoModelScalePart : public FITKAdaptorGeoCommand
    {
    public:
        explicit FITKAdaptorGeoModelScalePart() = default;
        virtual ~FITKAdaptorGeoModelScalePart() = default;
     ...
     * @brief  Part镜像适配器
     */
    class FITKINTERFACEGEOIOHDF5API FITKAdaptorGeoModelMirrorPart : public FITKAdaptorGeoCommand
    {
    public:
        explicit FITKAdaptorGeoModelMirrorPart() = default;
        virtual ~FITKAdaptorGeoModelMirrorPart() = default;
     ...
     * @brief  Part线性阵列适配器
     */
    class FITKINTERFACEGEOIOHDF5API FITKAdaptorGeoModelRectangularPatternPart : public FITKAdaptorGeoCommand
    {
    public:
        explicit FITKAdaptorGeoModelRectangularPatternPart() = default;
        virtual ~FITKAdaptorGeoModelRectangularPatternPart() = default;
     ...
     * @brief  Part环形阵列适配器
     */
    class FITKINTERFACEGEOIOHDF5API FITKAdaptorGeoModelCircularPatternPart : public FITKAdaptorGeoCommand
    {
    public:
        explicit FITKAdaptorGeoModelCircularPatternPart() = default;
        virtual ~FITKAdaptorGeoModelCircularPatternPart() = default;
