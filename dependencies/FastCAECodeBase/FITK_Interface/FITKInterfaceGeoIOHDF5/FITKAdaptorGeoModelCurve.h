...
namespace Interface
{
     ...
     * @date   2026-02-10
     */
    class FITKINTERFACEGEOIOHDF5API FITKAdaptorGeoModelMergeEdges : public FITKAdaptorGeoCommand
    {
    public:
        explicit FITKAdaptorGeoModelMergeEdges() = default;
        virtual ~FITKAdaptorGeoModelMergeEdges() = default;
