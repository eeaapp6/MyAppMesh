...
namespace Interface
{
     ...
     * @date   2026-06-25
     */
    class FITKINTERFACEGEOIOHDF5API FITKAdaptorGeoModelFromSketch : public FITKAdaptorGeoCommand
    {
    public:

        explicit FITKAdaptorGeoModelFromSketch() = default;
        virtual ~FITKAdaptorGeoModelFromSketch() = default;
     ...
     * @date   2026-06-25
     */
    class FITKINTERFACEGEOIOHDF5API FITKAdaptorGeoModelPlanarShell : public FITKAdaptorGeoCommand
    {
    public:

        explicit FITKAdaptorGeoModelPlanarShell() = default;
        virtual ~FITKAdaptorGeoModelPlanarShell() = default;
     ...
     * @date        2026-07-06
     */
    class FITKINTERFACEGEOIOHDF5API FITKAdaptorGeoModelShellFromSolid : public FITKAdaptorGeoCommand
    {
    public:

        explicit FITKAdaptorGeoModelShellFromSolid() = default;
        virtual ~FITKAdaptorGeoModelShellFromSolid() = default;
     ...
     * @date        2026-07-07
     */
    class FITKINTERFACEGEOIOHDF5API FITKAdaptorGeoModelWireEdgeFromEdge : public FITKAdaptorGeoCommand
    {
    public:

        explicit FITKAdaptorGeoModelWireEdgeFromEdge() = default;
        virtual ~FITKAdaptorGeoModelWireEdgeFromEdge() = default;
     ...
     * @date   2026-07-01
     */
    class FITKINTERFACEGEOIOHDF5API FITKAdaptorGeoModelRemoveWireEdges : public FITKAdaptorGeoCommand
    {
    public:

        explicit FITKAdaptorGeoModelRemoveWireEdges() = default;
        virtual ~FITKAdaptorGeoModelRemoveWireEdges() = default;
