...
#define FGKW_BottomRadius          "BottomRadius" //底面半径
#define FGKW_TopRadius             "TopRadius" //顶面半径
#define FGKW_BottomLength          "BottomLength" //底面长度
#define FGKW_BottomWidth           "BottomWidth" //底面宽度
#define FGKW_TopLength             "TopLength" //顶面长度
#define FGKW_TopWidth              "TopWidth" //顶面宽度
#define FGKW_XRadius               "XRadius" //X方向半径
#define FGKW_YRadius               "YRadius" //Y方向半径
#define FGKW_XLength               "XLength" //X方向边长
#define FGKW_YLength               "YLength" //Y方向边长
#define FGKW_IsFilled              "IsFilled" //是否填充
#define FGKW_StartRadius           "StartRadius" //起始位置半径
#define FGKW_FocalDepth            "FocalDepth" //焦点深度
#define FGKW_PlaneType             "PlaneType" //平面类型
#define FGKW_RotateX               "RotateX" //X方向旋转角度
#define FGKW_RotateY               "RotateY" //Y方向旋转角度
#define FGKW_RotateZ               "RotateZ" //Z方向旋转角度
#define FGKW_ScaleFactor           "ScaleFactor" //缩放倍率
#define FGKW_KeepOrigin            "KeepOrigin" //是否保留原模型
#define FGKW_CustomPlaneNormal     "CustomPlaneNormal" //自定义平面法向
#define FGKW_SourcePartId          "SourcePartId" //源部件ID

#define FGKW_OffsetMode           "OffsetMode"           // 偏移模式
#define FGKW_RelativeOffsetMode   "RelativeOffsetMode"   // 相对偏移模式
#define FGKW_OffsetDistance       "OffsetDistance"       // 偏移距离
#define FGKW_SrcFaceCount         "SrcFaceCount"         // 源面数量
#define FGKW_Ratio                "Ratio"                // 偏移比例
