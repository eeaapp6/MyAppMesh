...
/**********************************************************************
 * @file   FITKOFTurbSpalartAllmarasDDES.h
 * @brief  Spalart-Allmaras DDES 湍流数据接口声明
 * @author liuzhonghua (liuzhonghuaszch@163.com)
 * @date   2024-08-21
 *********************************************************************/
#ifndef _FITKOF_TURB_SpalartAllmarasDDES_H___
#define _FITKOF_TURB_SpalartAllmarasDDES_H___
...
{
    /**
     * @brief  Spalart-Allmaras DDES 湍流数据对象
     * @author liuzhonghua (liuzhonghuaszch@163.com)
     * @date   2024-08-21
     */
    class FITKInterfaceFlowOFAPI FITKOFTurbSpalartAllmarasDDES : public FITKAbstractOFTurbulence
    {
    public:
        explicit FITKOFTurbSpalartAllmarasDDES();
        virtual ~FITKOFTurbSpalartAllmarasDDES() = default;
