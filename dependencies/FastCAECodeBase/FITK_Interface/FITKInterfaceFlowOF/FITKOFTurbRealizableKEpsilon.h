...
/**********************************************************************
 * @file   FITKOFTurbRealizableKEpsilon.h
 * @brief  Realizable k-Epsilon 湍流数据接口声明
 * @author liuzhonghua (liuzhonghuaszch@163.com)
 * @date   2024-08-21
 *********************************************************************/
#ifndef _FITKOF_TURB_RealizableKEpsilon_H___
#define _FITKOF_TURB_RealizableKEpsilon_H___
...
{
    /**
     * @brief  Realizable k-Epsilon 湍流数据对象
     * @author liuzhonghua (liuzhonghuaszch@163.com)
     * @date   2024-08-21
     */
    class FITKInterfaceFlowOFAPI FITKOFTurbRealizableKEpsilon : public FITKAbstractOFTurbulence
    {
    public:
        explicit FITKOFTurbRealizableKEpsilon();
        virtual ~FITKOFTurbRealizableKEpsilon() = default;
