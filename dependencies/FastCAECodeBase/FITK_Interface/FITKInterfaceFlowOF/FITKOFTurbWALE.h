...
/**********************************************************************
 * @file   FITKOFTurbWALE.h
 * @brief  WALE 湍流数据接口声明
 * @author liuzhonghua (liuzhonghuaszch@163.com)
 * @date   2024-08-21
 *********************************************************************/
#ifndef _FITKOF_TURB_WALE_H___
#define _FITKOF_TURB_WALE_H___
...
namespace Interface
{
     ...
     * @date   2024-08-21
     */
    class FITKInterfaceFlowOFAPI FITKOFTurbWALE : public FITKAbstractOFTurbulence
    {
    public:
        explicit FITKOFTurbWALE();
        virtual ~FITKOFTurbWALE() = default;
