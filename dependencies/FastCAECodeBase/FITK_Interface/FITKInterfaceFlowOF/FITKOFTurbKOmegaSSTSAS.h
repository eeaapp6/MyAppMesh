...
/**********************************************************************
 * @file   FITKOFTurbKOmegaSSTSAS.h
 * @brief  k-Omega SST SAS 湍流数据接口声明
 * @author liuzhonghua (liuzhonghuaszch@163.com)
 * @date   2024-08-21
 *********************************************************************/
#ifndef _FITKOF_TURB_KOmegaSSTSAS_H___
#define _FITKOF_TURB_KOmegaSSTSAS_H___
...
{
    /**
     * @brief  k-Omega SST SAS 湍流数据对象
     * @author liuzhonghua (liuzhonghuaszch@163.com)
     * @date   2024-08-21
     */
    class FITKInterfaceFlowOFAPI FITKOFTurbKOmegaSSTSAS : public FITKAbstractOFTurbulence
    {
    public:
        explicit FITKOFTurbKOmegaSSTSAS();
        virtual ~FITKOFTurbKOmegaSSTSAS() = default;
