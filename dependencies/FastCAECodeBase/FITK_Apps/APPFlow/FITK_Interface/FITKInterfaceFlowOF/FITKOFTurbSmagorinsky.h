...
/**********************************************************************
 * @file   FITKOFTurbSmagorinsky.h
 * @brief  Smagorinsky 湍流数据接口声明
 * @author liuzhonghua (liuzhonghuaszch@163.com)
 * @date   2024-08-21
 *********************************************************************/
#ifndef _FITKOF_TURB_Smagorinsky_H___
#define _FITKOF_TURB_Smagorinsky_H___
...
{
    /**
     * @brief  Smagorinsky 湍流数据对象
     * @author liuzhonghua (liuzhonghuaszch@163.com)
     * @date   2024-08-21
     */
    class FITKInterfaceFlowOFAPI FITKOFTurbSmagorinsky : public FITKAbstractOFTurbulence
    {
    public:
        explicit FITKOFTurbSmagorinsky();
        virtual ~FITKOFTurbSmagorinsky() = default;
