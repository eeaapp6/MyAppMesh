...
/**********************************************************************
 * @file   FITKOFTurbKOmegaSSTIDDES.h
 * @brief  k-Omega SST IDDES 湍流数据接口声明
 * @author liuzhonghua (liuzhonghuaszch@163.com)
 * @date   2024-08-21
 *********************************************************************/
#ifndef _FITKOF_TURB_KOmegaSSTIDDES_H___
#define _FITKOF_TURB_KOmegaSSTIDDES_H___
...
{
    /**
     * @brief  k-Omega SST IDDES 湍流数据对象
     * @author liuzhonghua (liuzhonghuaszch@163.com)
     * @date   2024-08-21
     */
    class FITKInterfaceFlowOFAPI FITKOFTurbKOmegaSSTIDDES : public FITKAbstractOFTurbulence
    {
    public:
        explicit FITKOFTurbKOmegaSSTIDDES();
        virtual ~FITKOFTurbKOmegaSSTIDDES() = default;
