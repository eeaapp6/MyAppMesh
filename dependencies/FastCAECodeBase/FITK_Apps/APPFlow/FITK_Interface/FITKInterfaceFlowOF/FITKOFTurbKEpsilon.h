...
/**********************************************************************
 * @file   FITKOFTurbKEpsilon.h
 * @brief  k-Epsilon 湍流数据接口声明
 * @author liuzhonghua (liuzhonghuaszch@163.com)
 * @date   2024-08-21
 *********************************************************************/
#ifndef _FITKOF_TURB_KEPSILON_H___
#define _FITKOF_TURB_KEPSILON_H___
...
{
    /**
     * @brief  k-Epsilon 湍流数据对象
     * @author liuzhonghua (liuzhonghuaszch@163.com)
     * @date   2024-08-21
     */
    class FITKInterfaceFlowOFAPI FITKOFTurbKEpsilon : public FITKAbstractOFTurbulence
    {
    public:
        explicit FITKOFTurbKEpsilon();
        virtual ~FITKOFTurbKEpsilon() = default;
