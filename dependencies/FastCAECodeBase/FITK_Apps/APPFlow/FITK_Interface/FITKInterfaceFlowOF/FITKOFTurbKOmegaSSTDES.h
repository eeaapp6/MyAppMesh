...
/**********************************************************************
 * @file   FITKOFTurbKOmegaSSTDES.h
 * @brief  k-Omega SST DES 湍流数据接口声明
 * @author liuzhonghua (liuzhonghuaszch@163.com)
 * @date   2024-08-21
 *********************************************************************/
#ifndef _FITKOF_TURB_KOmegaSSTDES_H___
#define _FITKOF_TURB_KOmegaSSTDES_H___
...
{
    /**
     * @brief  k-Omega SST DES 湍流数据对象
     * @author liuzhonghua (liuzhonghuaszch@163.com)
     * @date   2024-08-21
     */
    class FITKInterfaceFlowOFAPI FITKOFTurbKOmegaSSTDES : public FITKAbstractOFTurbulence
    {
    public:
        explicit FITKOFTurbKOmegaSSTDES();
        virtual ~FITKOFTurbKOmegaSSTDES() = default;
