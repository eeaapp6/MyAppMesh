...
/**********************************************************************
 * @file   FITKOFTurbKKLOmega.h
 * @brief  k-kl-Omega 湍流数据接口声明
 * @author liuzhonghua (liuzhonghuaszch@163.com)
 * @date   2024-08-21
 *********************************************************************/
#ifndef _FITKOF_TURB_KKLOmega_H___
#define _FITKOF_TURB_KKLOmega_H___
...
{
    /**
     * @brief  k-kl-Omega 湍流数据对象
     * @author liuzhonghua (liuzhonghuaszch@163.com)
     * @date   2024-08-21
     */
    class FITKInterfaceFlowOFAPI FITKOFTurbKKLOmega : public FITKAbstractOFTurbulence
    {
    public:
        explicit FITKOFTurbKKLOmega();
        virtual ~FITKOFTurbKKLOmega() = default;
