...
/**********************************************************************
 * @file   FITKOFTurbSpalartAllmarasDES.h
 * @brief  Spalart-Allmaras DES 湍流数据接口声明
 * @author liuzhonghua (liuzhonghuaszch@163.com)
 * @date   2024-08-21
 *********************************************************************/
#ifndef _FITKOF_TURB_SpalartAllmarasDES_H___
#define _FITKOF_TURB_SpalartAllmarasDES_H___
...
{
    /**
     * @brief  Spalart-Allmaras DES 湍流数据对象
     * @author liuzhonghua (liuzhonghuaszch@163.com)
     * @date   2024-08-21
     */
    class FITKInterfaceFlowOFAPI FITKOFTurbSpalartAllmarasDES : public FITKAbstractOFTurbulence
    {
    public:
        explicit FITKOFTurbSpalartAllmarasDES();
        virtual ~FITKOFTurbSpalartAllmarasDES() = default;
