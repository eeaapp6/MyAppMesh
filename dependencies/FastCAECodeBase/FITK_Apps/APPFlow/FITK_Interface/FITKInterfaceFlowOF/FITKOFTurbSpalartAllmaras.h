...
/**********************************************************************
 * @file   FITKOFTurbSpalartAllmaras.h
 * @brief  Spalart-Allmaras 湍流数据接口声明
 * @author liuzhonghua (liuzhonghuaszch@163.com)
 * @date   2024-08-21
 *********************************************************************/
#ifndef _FITKOF_TURB_SpalartAllmaras_H___
#define _FITKOF_TURB_SpalartAllmaras_H___
...
{
    /**
     * @brief  Spalart-Allmaras 湍流数据对象
     * @author liuzhonghua (liuzhonghuaszch@163.com)
     * @date   2024-08-21
     */
    class FITKInterfaceFlowOFAPI FITKOFTurbSpalartAllmaras : public FITKAbstractOFTurbulence
    {
    public:
        explicit FITKOFTurbSpalartAllmaras();
        virtual ~FITKOFTurbSpalartAllmaras() = default;
