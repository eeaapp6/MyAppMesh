...
#include "SurfaceSplitterInfoDialog.h"
#include "ui_SurfaceSplitterInfoDialog.h"
...
namespace GUI {
    ...
    SurfaceSplitterInfoDialog::SurfaceSplitterInfoDialog(QWidget *parent) :
        GUIDialogBase(parent),
        m_Ui(new Ui::SurfaceSplitterInfoDialog)
    {
        m_Ui->setupUi(this);
    ...
    SurfaceSplitterInfoDialog::~SurfaceSplitterInfoDialog()
    {
        finalize();
        delete m_Ui;
    }

    SurfaceSplitterInfoDialog* SurfaceSplitterInfoDialog::New(QWidget * parent, EventOper::ParaWidgetInterfaceOper* oper, Interface::FITKAbsGeoCommand* cmd)
    {
        auto command = dynamic_cast<Interface::FITKAbsGeoSurfaceSplitter*>(cmd);

        static SurfaceSplitterInfoDialog* uniqueObj;
        if (uniqueObj == nullptr) {
            uniqueObj = new SurfaceSplitterInfoDialog(parent);
        }
    ...
    bool SurfaceSplitterInfoDialog::checkDialogData()
    {
        // 数据检查
    ...
    void SurfaceSplitterInfoDialog::finalize()
    {
        // 清除拾取状态
        if (m_GraphPickOper)
        {
    ...
    void SurfaceSplitterInfoDialog::on_comb_type_currentIndexChanged(int index)
    {
    ...
    void SurfaceSplitterInfoDialog::on_pb_sourcepick_clicked()
    {
        // 设置拾取信息
    ...
    void SurfaceSplitterInfoDialog::on_pb_toolpick_clicked()
    {
    ...
    void SurfaceSplitterInfoDialog::on_pb_ok_clicked()
    {
        // 检查输入
    ...
    void SurfaceSplitterInfoDialog::on_pb_preview_clicked()
    {
        // 检查数据
        ...
        if (m_PreviewCmd == nullptr) {
            ...
            m_PreviewCmd = fac->createCommandT<Interface::FITKAbsGeoSurfaceSplitter>(Interface::FITKGeoEnum::FITKGeometryComType::FGTSurfaceSplitter);
        }
        // 更新预览对象数据
    ...
    void SurfaceSplitterInfoDialog::on_pb_cancel_clicked()
    {
        // 结束对象操作。
        finalize();
