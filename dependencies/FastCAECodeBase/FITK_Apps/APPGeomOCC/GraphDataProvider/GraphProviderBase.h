...
namespace GraphData
{
    ...
    public:
        ...
        /**
         * @brief   清除全部管理中的可视化对象高亮与高级高亮效果。[虚函数]
         * @author  ChengHaotian (yeguangbaozi@foxmail.com)
         * @date    2024-09-05
         */
    ...
    protected:
         ...
         * @date    2024-06-12
         */
        GraphProviderBase(Render::FITKGraph3DWindowOCC* graphWidget);
         ...
         * @date    2024-06-12
         */
        void deleteObjsHash(QHash<int, Exchange::FITKOCCGraphObject3D*>& hash);
         ...
         * @date    2024-06-12
         */
        void deleteObjsHash(QHash<int, QHash<int, Exchange::FITKOCCGraphObject3D*>>& hash);
         ...
         * @date    2024-07-24
         */
        Exchange::FITKOCCGraphObject3D* getGraphObject(QString adaptorKeyName, QHash<int, Exchange::FITKOCCGraphObject3D*> & objDict, Core::FITKAbstractDataObject* dataObj);

        /**
         * @brief   通过数据对象、适配器关键字生成可视化对象。
         * @param   adaptorKeyName：适配器关键字
         * @param   key：注册字符键
         * @param   info：可视化对象信息[缺省]
         * @return  可视化对象
         * @author  ChengHaotian (yeguangbaozi@foxmail.com)
         * @date    2024-09-12
         */
        Exchange::FITKOCCGraphObject3D* getGraphObject(QString adaptorKeyName, QString key, QVariant info = QVariant());
    ...
    protected:
         ...
         * @date    2024-08-30
         */
        Interface::FITKGeoCommandList* m_geoData{ nullptr };
