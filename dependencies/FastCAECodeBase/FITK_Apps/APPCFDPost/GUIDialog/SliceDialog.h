 ...
 * @date   2024-09-18
 *********************************************************************/
#ifndef _SliceDialog_H
#define _SliceDialog_H
...
namespace GUI
{
     ...
     * @date   2024-09-18
     */
    class GUIDialogAPI SliceDialog :public GUIDialogBase
    {
        Q_OBJECT;
    public:
        /**
         ...
         * @date     2024-09-18
         */
        SliceDialog(int dataID, EventOper::ParaWidgetInterfaceOperator* oper, bool isCreate);
        /**
         * @brief    析构函数
         * @author   BaGuijun (baguijun@163.com)
         * @date     2024-09-18
    ...
    private slots:
         ...
         * @date     2024-10-08
         */
        void on_comboBox_SliceType_currentIndexChanged(int index);
    private:
        /**
         * @brief    创建初始化
         * @author   BaGuijun (baguijun@163.com)
