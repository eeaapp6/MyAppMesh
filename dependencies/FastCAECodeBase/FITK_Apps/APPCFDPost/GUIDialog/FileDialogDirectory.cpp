...
namespace GUI
{
    ...
    const QString FileDialogDirectory::splitExt = "@";    //用于文件头类型分割符，如12@dat
    ...
    void FileDialogDirectory::appendFileFilterType(QString filterString)
    {
        _ui->FileType->addItem(filterString);
        if (_ui->FileType->currentIndex() < 0) {
