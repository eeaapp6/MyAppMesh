...
/**********************************************************************
 * @file   FITKCFDPostClipSphere.h
 * @brief  后处理球形切割数据类
 * @author BaGuijun (baguijun@163.com)
 * @date   2024-09-06
 *********************************************************************/
#ifndef _FITKCFDPostClipSphere_H
#define _FITKCFDPostClipSphere_H
...
namespace Interface 
{
     ...
     * @date   2024-09-06
     */
    class FITKInterfaceCFDPostAPI FITKCFDPostClipSphere : public FITKAbstractCFDPostData
    {
        Q_OBJECT;
    public:
        /**
         ...
         * @date     2024-09-06
         */
        FITKCFDPostClipSphere(int parentID);
        /**
         * @brief    析构函数
         * @author   BaGuijun (baguijun@163.com)
         * @date     2024-09-06
         */
        virtual ~FITKCFDPostClipSphere();
        /**
         * @brief    获取后处理数据类型
