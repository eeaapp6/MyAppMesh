...
//        process.setArguments({ "-version", "5.2" });
    ...
    {
        // 注册字体资源。
        QResource::registerResource(qApp->applicationDirPath() + "/fonts.rcc");
    }
    ...
    void FITKGraph3DWindowInterface::SetUseActorTriangleFilter(bool flag)
    {
        FITKGraphActor::SetUseTriangleFilter(flag);
    }

    bool FITKGraph3DWindowInterface::GetUseActorTriangleFilter()
    {
        return FITKGraphActor::GetUseTriangleFilter();
    }
}