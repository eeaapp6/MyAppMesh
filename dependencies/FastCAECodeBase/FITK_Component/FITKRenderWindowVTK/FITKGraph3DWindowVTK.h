...
namespace Comp
{
    ...
    class FITKGraphAnnotationManager;
    class FITKGraphAnnotation;
    class FITKGraphObjectAnnotationManager;
    ...
    /**
     * @brief       The annotation graph object callback of the graph window.
     * @author      ChengHaotian (yeguangbaozi@foxmail.com)
     * @date        2026-05-13
     */
    class vtkAnnotationCallback : public QObject
    {
    public:
        /**
         * @brief       Constructor.
         ...
         * @date        2026-05-13
         */
        vtkAnnotationCallback(FITKGraph3DWindowVTK* graphWindow);
         ...
         * @date        2026-05-13
         */
        ~vtkAnnotationCallback() = default;

        /**
         * @brief       The call back of window interaction.
         * @param[in]   caller: The caller
         * @param[in]   eventId: Event id
         * @param[in]   callData: The data
         * @author      ChengHaotian (yeguangbaozi@foxmail.com)
         * @date        2026-05-13
         */
    ...
    public:
        ...
        /**
         * @brief       Get the annotation data manager.
         * @return      The annotation data manager
         * @author      ChengHaotian (yeguangbaozi@foxmail.com)
         * @date        2026-05-09
         */
        FITKGraphAnnotationManager* getAnnotationManager();

        /**
         * @brief       Get the annotation graph object manager.
         * @return      The annotation graph object manager
         * @author      ChengHaotian (yeguangbaozi@foxmail.com)
         * @date        2026-05-20
         */
        FITKGraphObjectAnnotationManager* getAnnotationGraphManager();

        /**
         * @brief       Get the temp annotation data object of the graph window.
         * @return      The temp annotation data object
         * @author      ChengHaotian (yeguangbaozi@foxmail.com)
         * @date        2026-05-12
         */
        FITKGraphAnnotation* getTempAnnotation();

        /**
         * @brief       Get the temp annotation graph object of the graph window.
         * @return      The temp annotation graph object
         * @author      ChengHaotian (yeguangbaozi@foxmail.com)
         * @date        2026-05-20
         */
        FITKGraphObjectAnnotation* getTempAnnotationGraph();

        /**
         * @brief       Create a new annotation and add it to the annotation manager.
         * @param[in]   name：The name of the annotation[default]
         * @return      The created annotation
         * @author      ChengHaotian (yeguangbaozi@foxmail.com)
         * @date        2026-05-11
         */
        FITKGraphAnnotation* createAnnotation(QString name = QString());

        /**
         * @brief       Transfer the world position to viewport position.
         * @param[in]   display2：The 2D display position
         * @param[in]   world3：The 3D world position
         * @return      Wether the renderer is valid
         * @author      ChengHaotian (yeguangbaozi@foxmail.com)
         * @date        2026-05-11
         */
        bool getDisplayPosByWorldPos(double* display2, double* world3);

        /**
         * @brief       Transfer the viewport position to world position.
         * @param[in]   world3：The 3D world position
         * @param[in]   display2：The 2D display position
         * @return      Wether the renderer is valid
         * @author      ChengHaotian (yeguangbaozi@foxmail.com)
         * @date        2026-05-11
         */
        bool getWorldPosByDisplayPos(double* world3, double* display2);
         ...
         * @param[i] shouldLogSaveImageInfo     是否记录保存图像的信息
         * @author   BaGuijun (baguijun@163.com)
         * @date     2025-12-15
         */
        void setCurImageType(Comp::FITKGraphWinImageType imageType,bool shouldLogSaveImageInfo = true);
        /**
         * @brief 保存当前渲染窗口为图片
         * @param[i]  image          图片路径
         * @param[i]  w              图片宽度
    ...
    private:
        ...
        /**
         * @brief       Inialize the temp annotation object.
         * @author      ChengHaotian (yeguangbaozi@foxmail.com)
         * @date        2026-05-12
         */
        void createTempAnnotation();
    ...
    protected:
         ...
         * @date   2026-05-18
         */
        bool _shouldLogSaveImageInfo = true;
        /**
         * @brief  默认初始化视角
         * @author libaojun (libaojunqd@foxmail.com)
         * @date   2024-11-21
         ...
         * @date        2026-05-09
         */
        FITKGraphAnnotationManager* m_annoMgr{ nullptr };
         ...
         * @date        2026-05-11
         */
        FITKGraphObjectAnnotationManager* m_annoGraphMgr{ nullptr };

        /**
         * @brief       The temp annotation data.
         * @author      ChengHaotian (yeguangbaozi@foxmail.com)
         * @date        2026-05-12
         */
        FITKGraphAnnotation* m_tempAnno{ nullptr };

        /**
         * @brief       The temp annotation graph object.
         * @author      ChengHaotian (yeguangbaozi@foxmail.com)
         * @date        2026-05-12
         */
        FITKGraphObjectAnnotation* m_tempAnnoGraph{ nullptr };
    ...
    private:
        ...
        /**
         * @brief       The callback of all annotation graph objects.
         * @author      ChengHaotian (yeguangbaozi@foxmail.com)
         * @date        2026-05-13
         */
        vtkAnnotationCallback* m_annoCb{ nullptr };

        /**
         * @brief       The tag list of all observers.
         * @author      ChengHaotian (yeguangbaozi@foxmail.com)
         * @date        2026-05-13
         */
        QList<unsigned long> m_cbTags;
