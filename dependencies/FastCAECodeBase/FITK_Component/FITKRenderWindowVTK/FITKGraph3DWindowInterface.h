...
namespace Comp
{
    ...
    public:
       ...
       */
        ...
        /**
         * @brief       设置是否使用三角形过滤器。[静态]
         * @param[in]   flag：是否使用三角形过滤器
         * @author      ChengHaotian (yeguangbaozi@foxmail.com)
         * @date        2026-07-09
         */
        static void SetUseActorTriangleFilter(bool flag);

        /**
         * @brief       获取是否使用三角形过滤器。[静态]
         * @return      是否使用三角形过滤器
         * @author      ChengHaotian (yeguangbaozi@foxmail.com)
         * @date        2026-07-09
         */
        static bool GetUseActorTriangleFilter();
