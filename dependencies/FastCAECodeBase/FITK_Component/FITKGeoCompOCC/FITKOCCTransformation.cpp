...
namespace OCC {
    ...
    bool FITKOCCModelMirror::update()
    {
        ...
        if (refCmd == nullptr) {
            ...
            auto vshape = refCmd->getShapeTopoByIndexT<FITKOCCTopoShape>(Interface::FITKGeoEnum::VTopoShapeType::VSFace, m_Reference.VirtualTopoIndex);
    ...
    bool FITKOCCModelCircularPattern::update()
    {
        ...
        auto vshape = axisCmd->getShapeTopoByIndexT<FITKOCCTopoShape>(Interface::FITKGeoEnum::VTopoShapeType::VSEdge, m_AxisShape.VirtualTopoIndex);
        if (vshape == nullptr) return false;
