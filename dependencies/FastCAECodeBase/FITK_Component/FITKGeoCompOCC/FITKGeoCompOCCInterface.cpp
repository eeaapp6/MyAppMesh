...
namespace OCC
{
    void FITKGeoCompOCCInterface::SetDefaultAngle(double angle)
    {
        FITKOCCShapeTriangulate::SetDefaultAngle(angle);
    }

    double FITKGeoCompOCCInterface::GetDefaultAngle()
    {
        return FITKOCCShapeTriangulate::GetDefaultAngle();
    }

    void FITKGeoCompOCCInterface::SetMinDeflectionAbs(double deflection)
    {
        FITKOCCShapeTriangulate::SetMinDeflectionAbs(deflection);
    }

    double FITKGeoCompOCCInterface::GetMinDeflectionAbs()
    {
        return FITKOCCShapeTriangulate::GetMinDeflectionAbs();
    }

    void FITKGeoCompOCCInterface::SetMaxDeflectionAbs(double deflection)
    {
        FITKOCCShapeTriangulate::SetMaxDeflectionAbs(deflection);
    }

    double FITKGeoCompOCCInterface::GetMaxDeflectionAbs()
    {
        return FITKOCCShapeTriangulate::GetMaxDeflectionAbs();
    }

    void FITKGeoCompOCCInterface::SetMinDeflectionRatio(double ratio)
    {
        FITKOCCShapeTriangulate::SetMinDeflectionRatio(ratio);
    }

    double FITKGeoCompOCCInterface::GetMinDeflectionRatio()
    {
        return FITKOCCShapeTriangulate::GetMinDeflectionRatio();
    }

    void FITKGeoCompOCCInterface::SetMaxDeflectionRatio(double ratio)
    {
        FITKOCCShapeTriangulate::SetMaxDeflectionRatio(ratio);
    }

    double FITKGeoCompOCCInterface::GetMaxDeflectionRatio()
    {
        return FITKOCCShapeTriangulate::GetMaxDeflectionRatio();
    }
    ...
    FITKGeoCompOCCInterface::FITKGeoCompOCCInterface()
    {
        ...
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTCone, [&]() {return new FITKOCCModelCone; });
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTFrustum, [&]() {return new FITKOCCModelFrustum; });
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTFilledRectangle, [&]() {return new FITKOCCModelFilledRectangle; });
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTFilledEllipse, [&]() {return new FITKOCCModelFilledEllipse; });
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTFilledPolygon, [&]() {return new FITKOCCModelFilledPolygon; });
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTFilledParaboloid, [&]() {return new FITKOCCModelFilledParaboloid; });
        ...
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTRemoveWireEdges, [&]() {return new FITKOCCModelRemoveWireEdges; });
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTWireEdgeFromEdge, [&]() {return new FITKOCCModelWireEdgeFromEdge; });
        ...
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTMergeEdges, [&]() {return new FITKOCCModelMergeEdges; });
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTMergePart, [&]() {return new FITKOCCModelMergePart; });
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTTranslatePart, [&]() {return new FITKOCCModelTranslatePart; });
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTRotatePart, [&]() {return new FITKOCCModelRotatePart; });
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTScalePart, [&]() {return new FITKOCCModelScalePart; });
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTMirrorPart, [&]() {return new FITKOCCModelMirrorPart; });
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTRectangularPatternPart, [&]() {return new FITKOCCModelRectangularPatternPart; });
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTCircularPatternPart, [&]() {return new FITKOCCModelCircularPatternPart; });
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTSplitPart, [&]() {return new FITKOCCModelSplitPart; });
        //@}
        ...
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTFromSketch, [&]() {return new FITKOCCModelFromSketch; });
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTPlanarShell, [&]() {return new FITKOCCModelPlanarShell; });
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTShellFromSolid, [&]() {return new FITKOCCModelShellFromSolid; });
        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTSolidFromShell, [&]() {return new FITKOCCModelSolidFromShell; });

        fac->insertCommandCreateFun(Interface::FITKGeoEnum::FGTOffsetFace, [&]() {return new FITKOCCModelOffsetFace; });
    }
