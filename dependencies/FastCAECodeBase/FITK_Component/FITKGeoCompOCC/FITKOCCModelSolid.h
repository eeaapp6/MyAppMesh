...
{
    /**
     * @brief       封闭壳面形成实体几何命令OCC实现类。
     * @author      ChengHaotian (yeguangbaozi@foxmail.com)
     * @date        2026-07-06
     */
    class FITKGeoCompOCCAPI FITKOCCModelSolidFromShell :
        public Interface::FITKAbsGeoModelSolidFromShell, public OCCShapeAgent
    {
    public:
        /**
         * @brief       构造函数。
         ...
         * @date        2026-07-06
         */
        virtual ~FITKOCCModelSolidFromShell() = default;
