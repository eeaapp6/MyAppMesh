...
namespace OCC
{
    ...
    bool FITKOCCModelSegment::update()
    {
        ...
        try {
            ...
            TopoDS_Shape output = edgeMaker.Shape();
            if (output.IsNull())
            {
                printLog(tr("Failed to make curve!"), 3);
                return false;
    ...
    bool FITKOCCModelWire::update()
    {
        ...
        try {
            ...
            TopoDS_Shape output = wire.Shape();
            if (output.IsNull())
            {
                printLog(tr("Failed to make curve!"), 3);
                return false;
    ...
    bool FITKOCCModelCircle::update()
    {
        ...
        try {
            BRepBuilderAPI_MakeEdge edgeMaker(c);
            if (!edgeMaker.IsDone())
            {
                printLog(tr("Failed to make curve!"), 3);
                return false;
    ...
    bool FITKOCCModelThreePointsCircle::update()
    {
        ...
        try
        {
            ...
            TopoDS_Shape output = edge.Shape();
            if (output.IsNull())
            {
                printLog("Failed to build shape!", 3);
                return false;
    ...
    bool FITKOCCModelCircleArc::update()
    {
        ...
        try {
            ...
            BRepBuilderAPI_MakeEdge edgeMaker(circleArc.Value());
            if (!edgeMaker.IsDone())
            {
                printLog(tr("Failed to make curve!"), 3);
                return false;
    ...
    bool FITKOCCModelEllipse::update()
    {
        ...
        std::array<double, 3> zDir = {
            m_XDirection[1] * m_YDirection[2] - m_YDirection[1] * m_XDirection[2],
            m_XDirection[2] * m_YDirection[0] - m_YDirection[2] * m_XDirection[0],
            m_XDirection[0] * m_YDirection[1] - m_YDirection[0] * m_XDirection[1]
        };

        // 通过Z轴和X轴反推Y轴：Y = Z × X
        std::array<double, 3> correctedYDir = {
            zDir[1] * m_XDirection[2] - m_XDirection[1] * zDir[2],
            zDir[2] * m_XDirection[0] - m_XDirection[2] * zDir[0],
            zDir[0] * m_XDirection[1] - m_XDirection[0] * zDir[1]
        };
        ...
        try {
            BRepBuilderAPI_MakeEdge edgeMaker(e);
            if (!edgeMaker.IsDone())
            {
                printLog(tr("Failed to make curve!"), 3);
                return false;
    ...
    bool FITKOCCModelEllipseArc::update()
    {
        ...
        try {
            ...
            BRepBuilderAPI_MakeEdge edgeMaker(ellipseArc.Value());
            if (!edgeMaker.IsDone())
            {
                printLog(tr("Failed to make curve!"), 3);
                return false;
    ...
    bool FITKOCCModelHyperbola::update()
    {
        ...
        try {
            BRepBuilderAPI_MakeEdge edgeMaker(h);
            if (!edgeMaker.IsDone())
            {
                printLog(tr("Failed to make curve!"), 3);
                return false;
    ...
    bool FITKOCCModelHyperbolaArc::update()
    {
        ...
        try {
            ...
            BRepBuilderAPI_MakeEdge edgeMaker(hyperArc.Value());
            if (!edgeMaker.IsDone())
            {
                printLog(tr("Failed to make curve!"), 3);
                return false;
    ...
    bool FITKOCCModelParabola::update()
    {
        ...
        try {
            const TopoDS_Shape & output = BRepBuilderAPI_MakeEdge(p).Shape();
            if (part && part->getAutoBool())
            {
                TopoDS_Shape* partShape{ nullptr };
                FITKAbstractOCCModel* partAgent = part->getTShapeAgent<FITKAbstractOCCModel>();
    ...
    bool FITKOCCModelThreePointsParabola::update()
    {
        ...
        try
        {
            ...
            const TopoDS_Shape& output = edge.Shape();
    ...
    bool FITKOCCModelParabolaArc::update()
    {
        ...
        try {
            ...
            const TopoDS_Shape& output = BRepBuilderAPI_MakeEdge(paraArc.Value()).Shape();
            if (part && part->getAutoBool())
            {
                TopoDS_Shape* partShape{ nullptr };
                FITKAbstractOCCModel* partAgent = part->getTShapeAgent<FITKAbstractOCCModel>();
    ...
    bool FITKOCCModelBeizeByControlPoints::update()
    {
        ...
        try {
            ...
            const TopoDS_Shape& output = anAisBezierCurve.Shape();
    ...
    bool FITKOCCModelBsplineByThroughPoints::update()
    {
        ...
        try {
            ...
            TopoDS_Shape output = anBCurve.Shape();
            if (output.IsNull())
            {
                printLog(tr("Failed to make curve!"), 3);
                return false;
    ...
    bool FITKOCCModelOffsetCurve::update()
    {
        ...
        if (cmd == nullptr) return false;
        auto vShape = cmd->getShapeTopoByIndexT<FITKOCCTopoShape>(Interface::FITKGeoEnum::VTopoShapeType::VSEdge, m_SourceCurve.VirtualTopoIndex);
        if (vShape == nullptr) return false;
        TopoDS_Shape shape = vShape->getTopoShape();
        ...
        try {
            ...
            const TopoDS_Shape& output = offsetEdge.Shape();
    ...
    bool FITKOCCModelCurveProjectionOnSurface::update()
    {
        ...
        try {
            ...
            const TopoDS_Shape& output = projEdge.Shape();
            if (part && part->getAutoBool())
            {
                TopoDS_Shape* partShape{ nullptr };
                FITKAbstractOCCModel* partAgent = part->getTShapeAgent<FITKAbstractOCCModel>();
    ...
    bool FITKOCCModelSurfaceIntersectionSurface::update()
    {
        ...
        auto surface1VShape = surface1Cmd->getShapeTopoByIndexT<FITKOCCTopoShape>(Interface::FITKGeoEnum::VTopoShapeType::VSFace, m_SourceSurface1.VirtualTopoIndex);
        ...
        auto surface2VShape = surface2Cmd->getShapeTopoByIndexT<FITKOCCTopoShape>(Interface::FITKGeoEnum::VTopoShapeType::VSFace, m_SourceSurface2.VirtualTopoIndex);
        ...
        try {
            ...
            const TopoDS_Shape& output = ss.Shape();
            if (part && part->getAutoBool())
            {
                TopoDS_Shape* partShape{ nullptr };
                FITKAbstractOCCModel* partAgent = part->getTShapeAgent<FITKAbstractOCCModel>();
    ...
    bool FITKOCCModelBridgeCurve::update()
    {
        ...
        auto curveVShape1 = curveCmd1->getShapeTopoByIndexT<FITKOCCTopoShape>(Interface::FITKGeoEnum::VTopoShapeType::VSEdge, m_SourceCurve1.VirtualTopoIndex);
        ...
        try {
            ...
            auto curveVShape2 = curveCmd2->getShapeTopoByIndexT<FITKOCCTopoShape>(Interface::FITKGeoEnum::VTopoShapeType::VSEdge, m_SourceCurve2.VirtualTopoIndex);
            ...
            const TopoDS_Shape& output = anEdge.Shape();
            if (part && part->getAutoBool())
            {
                TopoDS_Shape* partShape{ nullptr };
                FITKAbstractOCCModel* partAgent = part->getTShapeAgent<FITKAbstractOCCModel>();
