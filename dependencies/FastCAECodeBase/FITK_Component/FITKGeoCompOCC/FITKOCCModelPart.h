...
namespace OCC
{
    ...
    public:
         ...
         * @param[in]   fixShape：是否修复形状[缺省]
         * @author      ChengHaotian (yeguangbaozi@foxmail.com)
         * @date        2025-03-27
         */
        void updatePartShape(const TopoDS_Shape & shape, bool unite = false, bool fixShape = true);
    ...
    protected:
         ...
         * @param[out]  oShape：输出形状[引用]
         * @param[in]   fixShape：是否修复形状
         * @author      ChengHaotian (yeguangbaozi@foxmail.com)
         * @date        2025-09-01
         */
        void reUnite(const TopoDS_Shape & iShape, TopoDS_Shape & oShape, bool fixShape);
