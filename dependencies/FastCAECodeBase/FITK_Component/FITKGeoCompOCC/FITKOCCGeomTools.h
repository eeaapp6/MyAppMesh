...
namespace OCC
{
    ...
    public:
         ...
         * @date        2026-03-25
         */
        bool sampleEdge(Interface::FITKAbsVirtualTopo* vtp, int iNPoses, QVector<QVector<double>> & oPoses,
            QVector<QVector<double>> & oDirs, int iModelId = -1) override;
    };
    ...
    public:
         ...
         * @date        2026-03-24
         */
        bool getCylindSurfRadius(Interface::FITKAbsVirtualTopo* vtp, double & oRadius) override;
         ...
         * @date        2026-03-24
         */
        bool getCylindSurfInfo(Interface::FITKAbsVirtualTopo* vtp, double* oCt, double* oDir, double & oRadius, double* oBds) override;
         ...
         * @date        2026-03-24
         */
        bool getConeSurfInfo(Interface::FITKAbsVirtualTopo* vtp, double* oCt, double* oApex, double* oDir, double & oRadius, double* oBds) override;
    ...
    public:
         ...
         * @date        2026-05-25
         */
        bool getSlice(const int cmdId, double* iOrg, double* iNor, QHash<int, Interface::FITKGeoMeshVSFaceEntity*>& oSolidFaces,
            int iModelId = -1) override;

        /**
         * @brief       获取给定线的分段信息。[重写]
         * @param[in]   iPoses：输入点坐标
         * @param[out]  oSegPoses：输出分段点坐标[引用]
         * @param[in]   isSpline：是否为样条曲线
         * @return      是否存在有效分段
         * @author      ChengHaotian (yeguangbaozi@foxmail.com)
         * @date        2026-07-02
         */
        bool getWireSegs(QList<QList<double>>& iPoses,
            QList<QList<double>>& oSegPoses, bool isSpline = false) override;
