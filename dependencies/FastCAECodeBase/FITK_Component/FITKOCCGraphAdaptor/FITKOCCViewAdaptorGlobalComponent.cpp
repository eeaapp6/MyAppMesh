...
#include "FITKOCCViewAdaptorGlobalComponent.h"
...
namespace Exchange
{
    bool FITKOCCViewAdaptorGlobalComponent::update()
    {
        if (!_dataObj)
        {
            return false;
        ...
        FITKOCCGraphObjectGlobalComponent* outputData = new FITKOCCGraphObjectGlobalComponent(globalComp);
