...
#include "FITKOCCViewAdaptorModelCommand.h"
...
namespace Exchange
{
    bool FITKOCCViewAdaptorModelCommand::update()
    {
        if (!_dataObj)
        {
            return false;
        ...
        FITKOCCGraphObjectModelCommand* outputData = new FITKOCCGraphObjectModelCommand(model);
