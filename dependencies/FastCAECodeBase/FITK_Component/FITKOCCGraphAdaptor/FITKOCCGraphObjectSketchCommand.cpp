...
namespace Exchange
{
    FITKOCCGraphObjectSketchCommand::FITKOCCGraphObjectSketchCommand(Interface::FITKAbsGeoSketch2D* sketchData)
        : FITKOCCGraphObjectModelCommand()
    {
        if (!sketchData)
        {
            return;
    ...
    void FITKOCCGraphObjectSketchCommand::addSelectMode(CommonOCC::SelectMode mode, bool force)
    {
        // Clear select modes.
