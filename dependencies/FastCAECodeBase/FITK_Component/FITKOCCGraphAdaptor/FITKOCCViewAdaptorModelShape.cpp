...
#include "FITKOCCViewAdaptorModelShape.h"
...
namespace Exchange
{
    bool FITKOCCViewAdaptorModelShape::update()
    {
        if (!_dataObj)
        {
            return false;
        ...
        FITKOCCGraphObjectModelCommand* outputData = new FITKOCCGraphObjectModelCommand(cmd);
