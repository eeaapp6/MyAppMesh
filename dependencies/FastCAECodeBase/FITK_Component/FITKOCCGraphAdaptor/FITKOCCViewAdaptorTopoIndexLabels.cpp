...
#include "FITKOCCViewAdaptorTopoIndexLabels.h"
...
namespace Exchange
{
    bool FITKOCCViewAdaptorTopoIndexLabels::update()
    {
        if (!_dataObj)
        {
            return false;
        ...
        Interface::FITKAbsVirtualTopo* vTopo = dynamic_cast<Interface::FITKAbsVirtualTopo*>(_dataObj);
        if (!vTopo)
        {
            return false;
        }
        ...
        FITKOCCGraphObjectTopoIndexLabels* outputData = new FITKOCCGraphObjectTopoIndexLabels(vTopo);
