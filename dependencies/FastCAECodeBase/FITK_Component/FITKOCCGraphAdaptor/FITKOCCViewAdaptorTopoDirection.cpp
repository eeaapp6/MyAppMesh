...
#include "FITKOCCViewAdaptorTopoDirection.h"
...
namespace Exchange
{
    bool FITKOCCViewAdaptorTopoDirection::update()
    {
        if (!_dataObj)
        {
            return false;
        ...
        FITKOCCGraphObjectTopoDirection* outputData = new FITKOCCGraphObjectTopoDirection(vTopo);
