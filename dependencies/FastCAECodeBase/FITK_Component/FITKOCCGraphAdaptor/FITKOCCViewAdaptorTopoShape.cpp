...
#include "FITKOCCViewAdaptorTopoShape.h"
...
namespace Exchange
{
    bool FITKOCCViewAdaptorTopoShape::update()
    {
        if (!_dataObj)
        {
            return false;
        ...
        FITKOCCGraphObjectTopoShape* outputData = new FITKOCCGraphObjectTopoShape(vTopo);
