...
namespace Exchange
{
    FITKOCCGraphObjectModelShape::FITKOCCGraphObjectModelShape(Interface::FITKAbsGeoShapeAgent* modelData)
    ...
    FITKOCCGraphObjectModelShape::~FITKOCCGraphObjectModelShape()
    {
        // Delete indice map.
    ...
    bool FITKOCCGraphObjectModelShape::initShapeData()
    {
    ...
    Interface::FITKAbsGeoCommand* FITKOCCGraphObjectModelShape::getGeoCommand()
    {
        ...
        return shapeAgent->getGeoCommand();
    }

    bool FITKOCCGraphObjectModelShape::getDataVisibility()
    {
        Interface::FITKAbsGeoShapeAgent* shapeAgent = dynamic_cast<Interface::FITKAbsGeoShapeAgent*>(_dataObj);
        if (!shapeAgent)
        {
    ...
    void FITKOCCGraphObjectModelShape::update(bool forceUpdate)
    {
        if (!m_fAisShape)
        {
            return;
