...
#include "FITKOCCViewAdaptorModelShapePreview.h"
...
namespace Exchange
{
    bool FITKOCCViewAdaptorModelShapePreview::update()
    {
        if (!_dataObj)
        {
            return false;
        ...
        FITKOCCGraphObjectModelShapePreview* outputData = new FITKOCCGraphObjectModelShapePreview(shapeAgent);
