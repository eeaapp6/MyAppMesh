...
#include "FITKOCCViewAdaptorModelCommandPreview.h"
...
namespace Exchange
{
    bool FITKOCCViewAdaptorModelCommandPreview::update()
    {
        if (!_dataObj)
        {
            return false;
        ...
        FITKOCCGraphObjectModelCommandPreview* outputData = new FITKOCCGraphObjectModelCommandPreview(model);
