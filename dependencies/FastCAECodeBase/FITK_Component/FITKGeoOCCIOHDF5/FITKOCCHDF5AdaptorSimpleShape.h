...
#include "FITK_Interface/FITKInterfaceGeoIOHDF5/FITKAdaptorGeoModelCone.h"
#include "FITK_Interface/FITKInterfaceGeoIOHDF5/FITKAdaptorGeoModelFrustum.h"
#include "FITK_Interface/FITKInterfaceGeoIOHDF5/FITKAdaptorGeoModelFilledEllipse.h"
#include "FITK_Interface/FITKInterfaceGeoIOHDF5/FITKAdaptorGeoModelFilledRectangle.h"
#include "FITK_Interface/FITKInterfaceGeoIOHDF5/FITKAdaptorGeoModelFilledParaboloid.h"
#include "FITK_Interface/FITKInterfaceGeoIOHDF5/FITKAdaptorGeoModelFilledPolygon.h"
#include "FITK_Interface/FITKInterfaceGeoIOHDF5/FITKAdaptorGeoModelMergePart.h"
#include "FITK_Interface/FITKInterfaceGeoIOHDF5/FITKAdaptorGeoModelSplitPart.h"
#include "FITK_Interface/FITKInterfaceGeoIOHDF5/FITKAdaptorGeoModel.h"
...
namespace OCC
{
    ...
    FITKOCCAdaptorDec(FITKOCCAdaptorGeoModelCone, Interface::FITKAdaptorGeoModelCone)
    Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoModelCone, FITKOCCAdaptorGeoModelCone)

    FITKOCCAdaptorDec(FITKOCCAdaptorGeoModelFrustum, Interface::FITKAdaptorGeoModelFrustum)
    Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoModelFrustum, FITKOCCAdaptorGeoModelFrustum)

    FITKOCCAdaptorDec(FITKOCCAdaptorGeoModelFilledEllipse, Interface::FITKAdaptorGeoModelFilledEllipse)
    Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoModelFilledEllipse, FITKOCCAdaptorGeoModelFilledEllipse)

    FITKOCCAdaptorDec(FITKOCCAdaptorGeoModelFilledRectangle, Interface::FITKAdaptorGeoModelFilledRectangle)
    Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoModelFilledRectangle, FITKOCCAdaptorGeoModelFilledRectangle)

    FITKOCCAdaptorDec(FITKOCCAdaptorGeoModelFilledParaboloid, Interface::FITKAdaptorGeoModelFilledParaboloid)
    Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoModelFilledParaboloid, FITKOCCAdaptorGeoModelFilledParaboloid)

    FITKOCCAdaptorDec(FITKOCCAdaptorGeoModelFilledPolygon, Interface::FITKAdaptorGeoModelFilledPolygon)
    Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoModelFilledPolygon, FITKOCCAdaptorGeoModelFilledPolygon)

    FITKOCCAdaptorDec(FITKOCCAdaptorGeoModelMergePart, Interface::FITKAdaptorGeoModelMergePart)
    Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoModelMergePart, FITKOCCAdaptorGeoModelMergePart)

    FITKOCCAdaptorDec(FITKOCCAdaptorGeoModelSplitPart, Interface::FITKAdaptorGeoModelSplitPart)
    Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoModelSplitPart, FITKOCCAdaptorGeoModelSplitPart)
    ...
    FITKOCCAdaptorDec(FITKOCCAdaptorGeoModelTranslatePart, Interface::FITKAdaptorGeoModelTranslatePart)
    Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoModelTranslatePart, FITKOCCAdaptorGeoModelTranslatePart)

    FITKOCCAdaptorDec(FITKOCCAdaptorGeoModelRotatePart, Interface::FITKAdaptorGeoModelRotatePart)
    Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoModelRotatePart, FITKOCCAdaptorGeoModelRotatePart)

    FITKOCCAdaptorDec(FITKOCCAdaptorGeoModelScalePart, Interface::FITKAdaptorGeoModelScalePart)
    Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoModelScalePart, FITKOCCAdaptorGeoModelScalePart)

    FITKOCCAdaptorDec(FITKOCCAdaptorGeoModelMirrorPart, Interface::FITKAdaptorGeoModelMirrorPart)
    Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoModelMirrorPart, FITKOCCAdaptorGeoModelMirrorPart)

    FITKOCCAdaptorDec(FITKOCCAdaptorGeoModelRectangularPatternPart, Interface::FITKAdaptorGeoModelRectangularPatternPart)
    Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoModelRectangularPatternPart, FITKOCCAdaptorGeoModelRectangularPatternPart)

    FITKOCCAdaptorDec(FITKOCCAdaptorGeoModelCircularPatternPart, Interface::FITKAdaptorGeoModelCircularPatternPart)
    Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoModelCircularPatternPart, FITKOCCAdaptorGeoModelCircularPatternPart)
    ...
    FITKOCCAdaptorDec(FITKOCCAdaptorGeoModelFromSketch, Interface::FITKAdaptorGeoModelFromSketch)
    Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoModelFromSketch, FITKOCCAdaptorGeoModelFromSketch)
    ...
    Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoOperNBodyUnite, FITKOCCAdaptorGeoOperNBodyUnite)
        ...
        FITKOCCAdaptorDec(FITKOCCAdaptorGeoModelMergeEdges, Interface::FITKAdaptorGeoModelMergeEdges)
        Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoMergeEdges, FITKOCCAdaptorGeoModelMergeEdges)
        
        FITKOCCAdaptorDec(FITKOCCAdaptorModelRemoveWireEdges, Interface::FITKAdaptorGeoModelRemoveWireEdges)
        Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoRemoveWireEdges, FITKOCCAdaptorModelRemoveWireEdges)

        class FITKGEOOCCIOHDF5API FITKOCCAdaptorGeoWireEdgeFromEdge : public Interface::FITKAdaptorGeoCommand,
            public FITKOCCShapeHDF5IOHelper
        {
        public:
            explicit FITKOCCAdaptorGeoWireEdgeFromEdge() = default;
            virtual ~FITKOCCAdaptorGeoWireEdgeFromEdge() = default;

        protected:
            bool writeShape(H5::Group & g) override;
            bool readShape() override;
            bool writeParameters(H5::Group & g) override;
            bool readParameters() override;
        };
        Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoWireEdgeFromEdge, FITKOCCAdaptorGeoWireEdgeFromEdge)

        FITKOCCAdaptorDec(FITKOCCAdaptorGeoModelOffsetFace, Interface::FITKAdaptorGeoModelOffsetFace)
        Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoOffsetFace, FITKOCCAdaptorGeoModelOffsetFace)

        FITKOCCAdaptorDec(FITKOCCAdaptorGeoModelShellFromSolid, Interface::FITKAdaptorGeoModelShellFromSolid)
        Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoModelShellFromSolid, FITKOCCAdaptorGeoModelShellFromSolid)

        FITKOCCAdaptorDec(FITKOCCAdaptorGeoModelSolidFromShell, Interface::FITKAdaptorGeoModelSolidFromShell)
        Register2FITKIOAdaptorFactory(HDF5, Interface::FITKAbsGeoModelSolidFromShell, FITKOCCAdaptorGeoModelSolidFromShell)
}
