...
namespace Core
{
    ...
    public:
         ...
         * @date 2024-02-22
         */
        void appendData(FITKAbstractDataObject* obj, bool changeParentID = true);
         ...
         * @date 2024-08-27
         */
        void appendData(const QList<FITKAbstractDataObject*>& objs, bool changeParentID = true);
        /**
         * @brief 获取管理的数据数量
         * @return int 数据数量
         * @author LiBaojun (libaojunqd@foxmail.com)
         ...
         * @date 2024-02-22
         */
        void insertDataObj(int index, FITKAbstractDataObject* item, bool changeParentID = true);
        /**
