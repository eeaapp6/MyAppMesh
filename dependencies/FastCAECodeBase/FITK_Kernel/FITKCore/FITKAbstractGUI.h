...
namespace Core
{
    ...
    public:
         ...
         * @date 2024-03-02
         */
        explicit FITKWidget(QWidget* parent = nullptr, Qt::WindowFlags f = Qt::WindowFlags());
    ...
    public:
         ...
         * @date 2024-03-02
         */
        explicit FITKMainWindow(QWidget* parent = nullptr, Qt::WindowFlags f = Qt::WindowFlags());
    ...
    public:
         ...
         * @date 2024-03-02
         */
        explicit FITKRibbonMainWindow(QWidget* parent = nullptr, Qt::WindowFlags f = Qt::WindowFlags());
