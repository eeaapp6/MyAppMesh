...
namespace Core
{
    FITKWidget::FITKWidget(QWidget * parent, Qt::WindowFlags f) :
        QWidget(parent, f)
    {
...
//        this->repaint();
    ...
    FITKMainWindow::FITKMainWindow(QWidget * parent, Qt::WindowFlags f) :
    ...
    FITKRibbonMainWindow::FITKRibbonMainWindow(QWidget * parent, Qt::WindowFlags f) :
        QMainWindow(parent, f)
    {
